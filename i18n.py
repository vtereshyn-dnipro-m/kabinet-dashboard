...
TRANSLATIONS = {
    ...
    "ads.limits": {
        "ru": "<b>Только Испания.</b> Часть строк Amazon скрывает — суммы ниже, чем в рекламном кабинете.",
        "uk": "<b>Лише Іспанія.</b> Частину рядків Amazon приховує — суми нижчі, ніж у рекламному кабінеті.",
        "en": "<b>Spain only.</b> Amazon hides some rows — totals are lower than in the ad console.",
    },
    ...
    "ads.filter.market_one": {
        "ru": "Рынок один: инстанс AMC пока единственный, выбирать не из чего.",
        "uk": "Ринок один: інстанс AMC поки єдиний, обирати нема з чого.",
        "en": "One marketplace: there is still a single AMC instance, nothing to choose from.",
    },
