...
TRANSLATIONS = {
    ...
    "ads.limits": {"ru": "<b>Только Испания.</b> Часть строк Amazon скрывает — суммы ниже, чем в рекламном кабинете. Доступные рынки: {m}.", "uk": "<b>Лише Іспанія.</b> Частину рядків Amazon приховує — суми нижчі, ніж у рекламному кабінеті. Доступні ринки: {m}.", "en": "<b>Spain only.</b> Amazon hides some rows — totals are lower than in the ad console. Available marketplaces: {m}."},
    ...
    "ads.filter.market_one": {"ru": "Рынок: {m} — инстанс AMC пока один, выбирать не из чего.", "uk": "Ринок: {m} — інстанс AMC поки один, обирати нема з чого.", "en": "Marketplace: {m} — there is only one AMC instance so far, nothing to choose from."},
