...
TRANSLATIONS = {
    ...
    "rev.asin.name_src_help": {"ru": "Пусто — название пришло с того же рынка, что и в колонке рынка, язык совпадает. Код страны — своего названия по этому рынку нет, показано с другого, и язык чужой. «Склад» — название взято с местного склада, рынка у него нет вовсе.", "uk": "Порожньо — назва прийшла з того самого ринку, що й у колонці ринку, мова збігається. Код країни — своєї назви за цим ринком немає, показано з іншого, і мова чужа. «Склад» — назву взято з місцевого складу, ринку в неї немає взагалі.", "en": "Blank — the name came from the same marketplace shown in the market column, so the language matches. A country code — there is no name for this marketplace, so one from another is shown and the language is foreign. “Warehouse” — the name comes from the local warehouse, which has no marketplace at all."},
