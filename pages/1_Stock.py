...
with tab_cov:
    ...
    if cov.empty:
        ...
        for c in ("available_now", "coverage_weeks", "fbm_fallback_qty",
                  ...
                  "odoo_incoming_stores_qty", "weeks_until_first_gap"):
            if c in cov.columns:
        ...
        if cv.empty:
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    "odoo_incoming_stores_qty": st.column_config.NumberColumn(
                        t("stock.cov.col_odoo_stores"), format="%.0f", width="small",
                        help=t("stock.cov.col_odoo_stores_help")),
            ...
            stores_q = float(prow.get("odoo_incoming_stores_qty") or 0)
            if stores_q > 0:
                st.caption(t("stock.cov.odoo_stores_note", qty=int(stores_q)))
